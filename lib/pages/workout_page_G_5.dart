...
class WorkoutPageG5 extends StatefulWidget {
  final String workoutName;
  const WorkoutPageG5({super.key, required this.workoutName});

  @override
  State<WorkoutPageG5> createState() => _WorkoutPageG5State();
}

class _WorkoutPageG5State extends State<WorkoutPageG5> {

  void onCheckBoxChanged(String workoutName, String exerciseName) {
    Provider.of<WorkoutDataG5>(context, listen: false).
  ...
  void save() {
    Provider.of<WorkoutDataG5>(context, listen: false).addExercise(
