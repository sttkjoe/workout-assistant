...
class WorkoutPageH3 extends StatefulWidget {
  final String workoutName;
  const WorkoutPageH3({super.key, required this.workoutName});

  @override
  State<WorkoutPageH3> createState() => _WorkoutPageH3State();
}

class _WorkoutPageH3State extends State<WorkoutPageH3> {

  void onCheckBoxChanged(String workoutName, String exerciseName) {
    Provider.of<WorkoutDataH3>(context, listen: false).
  ...
  void save() {
    Provider.of<WorkoutDataH3>(context, listen: false).addExercise(
