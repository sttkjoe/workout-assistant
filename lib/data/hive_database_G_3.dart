...
class HiveDBG3 {
  ...
  final _hBox = Hive.box("workoutassistant_db1");
  ...
  if (_hBox.containsKey("START_DATE")) {
    ...
    _hBox.put("START_DATE", startDate); // store the start date in the database
    return startDate;
  }
}
  ...
  void saveToDB(List<Workout> workouts) {
    //converting to string so that it can be saved
